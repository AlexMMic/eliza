...
class EmotionConverter:
    def __init__(self):
        ...
        self.stringConvertList.append(tempList)
        tempList = [ "missgelaunt", (-0.5, 0.0, 1.0) ]
        self.stringConvertList.append(tempList)
        tempList = [ "erfreut", (0.5, 0.0, 1.0) ]
        self.stringConvertList.append(tempList)
        tempList = [ "erfreut", (0.5, 0.0, -1.0) ]
        self.stringConvertList.append(tempList)
        ...
        self.stringConvertList.append(tempList)
        tempList = [ "ausgeglichen", (0.0, 0.0, 0.0) ]
        self.stringConvertList.append(tempList)

    def foreignData(self, list):
        v = (0.0, 0.0, 0.0)
        if len(list) == 4:
            emoX = list[0]
            moodY = list[1]
    ...
    def getString(self, paddata):
        self.s = "ausgeglichen"
        self.actualStringConvertElement = {"ausgeglichen",(0, 0, 0)}
        emoDistance = 10.0
...
class EmotionalAgent:
    def __init__(self):
        ...
        self.myEmotionDynamics.calculate()

    def calculate_emotions(self):
        self.myEmotionDynamics.calculate()
        self.myEmotionConverter.getString(self.myEmotionConverter.foreignData(self.myEmotionDynamics.get_emotion_list()))

    def calculate_emotions_continuously(self):
        while True: #calculate emotional state every 2 seconds
    ...
    def send_random_emoimpulse(self):
        ...
        self.myEmotionDynamics.emoimpulse(emoimp)

    def emoimpulse(self, impulse):
        self.myEmotionDynamics.emoimpulse(impulse)
